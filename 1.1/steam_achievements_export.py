...
class SteamAchievementsGUI:
    def __init__(self, root):
        ...
        # アプリのアイコン
        try:
            self._icon_image = tk.PhotoImage(file="steam_achi.png")
    ...
    def _build_settings_tab(self):
        ...
        # 🔹 検索ウィンドウと同じような「丸い入力ボックス」を作るヘルパー
    ...
    def browse_output_path(self):
        initial_dir = os.path.dirname(self.output_path.get()) or "C:\\"
